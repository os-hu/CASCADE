import unittest
import os
from src.implementations.analysis.analysis_executor.Java_Executor import Java_Executor
...
class test_Java_Execution(unittest.TestCase):
    def test_source_execute(self):
        executor = Java_Executor(debug=True)
