...
class Python_Extraction(Extraction):
    """
    ...
    def extract(self, input_path, output_path, print_mode=False) -> dict:
        ...
        "called_functions": [],
        "tests": "",
            # the tests shoudl be i na format such that they can be put at the verry top of the project and be able to import the desired function.
        "test_imports": [],
        "test_file_path": "",
